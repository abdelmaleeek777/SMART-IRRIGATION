  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-950 px-4 py-12 text-white">
      <div className="w-full max-w-md rounded-3xl border border-white/10 bg-white/5 p-8 shadow-soft backdrop-blur">
        <p className="text-sm font-semibold uppercase tracking-[0.25em] text-cyan-300">Connexion</p>
        <h1 className="mt-2 text-3xl font-bold">Accéder au tableau de bord</h1>
        <form className="mt-8 space-y-4">
          ...
          <input className="w-full rounded-2xl border border-white/10 bg-white/10 px-4 py-3 text-white placeholder:text-slate-400 outline-none focus:border-cyan-400" placeholder="Mot de passe" type="password" />
        ...
        <p className="mt-6 text-sm text-slate-300">
          ...
          <Link to="/auth/register" className="font-semibold text-cyan-300">
            Créer un compte
          </Link>
        </p>
      </div>
